...
type BlockID struct {
	...
	HashAbiEncoded []byte        `protobuf:"bytes,3,opt,name=hash_abi_encoded,json=hashAbiEncoded,proto3" json:"hash_abi_encoded,omitempty"`
}
...
func (m *BlockID) GetHashAbiEncoded() []byte {
	if m != nil {
		return m.HashAbiEncoded
	}
	return nil
}
...
var fileDescriptor_d3a6e55e2345de56 = []byte{
	...
	,
}
...
func (m *BlockID) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.HashAbiEncoded) > 0 {
		i -= len(m.HashAbiEncoded)
		copy(dAtA[i:], m.HashAbiEncoded)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.HashAbiEncoded)))
		i--
		dAtA[i] = 0x1a
	}
	{
...
func (m *BlockID) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field HashAbiEncoded", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.HashAbiEncoded = append(m.HashAbiEncoded[:0], dAtA[iNdEx:postIndex]...)
			if m.HashAbiEncoded == nil {
				m.HashAbiEncoded = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
